...
class EnvironmentTSN(gym.Env):
    ...
    def __init__(self, log_file_id, evaluate):
        ...
        self.island_destination = None  # Contains the ID of the destination node within the current TSN zone.
        #                                 Could be the final destination or a border node belonging to another TSN zone
