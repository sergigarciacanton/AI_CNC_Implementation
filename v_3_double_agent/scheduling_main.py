from scheduling_environment import EnvironmentTSN
from scheduling_dqn import DQNAgent
from scheduling_config import TIMESTEPS_LIMIT, BACKGROUND_STREAMS


main_id = 'scheduling_1'
...
if option == 0:
    ...
    routing_model_name = input('[*] Introduce the name of the scheduling model: ')
